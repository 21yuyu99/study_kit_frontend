  ...
  return(
    ...
    <div className={styles.signUp}>
      ...
      <Link href={`https://accounts.google.com/o/oauth2/v2/auth?scope=profile email&response_type=code&client_id=${
            process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}&redirect_uri=${process.env.NEXT_PUBLIC_GOOGLE_REDIRECT_URI}`}><div className={styles.google}><Google/><h3>구글로 바로 시작하기</h3></div></Link>
  </div>	
    </>
  )
}