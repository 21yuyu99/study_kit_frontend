...
export default function NewStudy(){
 ...
 return(
  ...
  <main className={styles.main}>
    ...
    <StudyTypeBar/>
    <StudyCard cardLink={''} typeName={"언어"} starStatus={true} cardTag={['#문제풀이',' #실습']} cardTitle="오픽 자격증 따기" cardPeriod='12월 18일~(27일째 스터디 중)' progressStatus={80}></StudyCard>
    <StudyCard cardLink={''} typeName={"기타"} starStatus={true}cardTag={['#문제풀이',' #실습']} cardTitle="오픽 자격증 따기" cardPeriod='12월 18일~(27일째 스터디 중)' progressStatus={40}></StudyCard>
    <StudyCard cardLink={''} typeName={"자격증"} starStatus={false}cardTag={['#문제풀이',' #실습']} cardTitle="오픽 자격증 따기" cardPeriod='12월 18일~(27일째 스터디 중)' progressStatus={20}></StudyCard>
    <StudyCard cardLink={''} typeName={"취/창업"} starStatus={false}cardTag={['#문제풀이',' #실습']} cardTitle="오픽 자격증 따기" cardPeriod='12월 18일~(27일째 스터디 중)' progressStatus={40}></StudyCard>
    <StudyCard cardLink={''} typeName={"프로젝트"} starStatus={false}cardTag={['#문제풀이',' #실습']} cardTitle="오픽 자격증 따기" cardPeriod='12월 18일~(27일째 스터디 중)' progressStatus={80}></StudyCard>
